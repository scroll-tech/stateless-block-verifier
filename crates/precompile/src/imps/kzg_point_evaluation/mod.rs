...
use sbv_primitives::revm::precompile::{PrecompileWithAddress, kzg_point_evaluation};

pub use kzg_point_evaluation::{
    ADDRESS, GAS_COST, RETURN_VALUE, VERSIONED_HASH_VERSION_KZG, kzg_to_versioned_hash,
};

#[cfg(not(feature = "openvm-kzg"))]
pub use kzg_point_evaluation::{run, verify_kzg_proof};

#[cfg(feature = "openvm-kzg")]
mod openvm;
#[cfg(feature = "openvm-kzg")]
pub use openvm::{run, verify_kzg_proof};
